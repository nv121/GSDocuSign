...
//
exports.config = {
    dsClientId: process.env.DS_CLIENT_ID || '8c50f1a5-b737-43c8-aad8-9f1a02fbaba7' // The app's DocuSign integration key
    , dsClientSecret: process.env.DS_CLIENT_SECRET || '1f1ac992-0ccb-462f-b8c6-ef8c07ecce14' // The app's DocuSign integration key's secret
    , signerEmail: process.env.DS_SIGNER_EMAIL || 'fdale121@aol.com'
    , signerName: process.env.DS_SIGNER_NAME || 'Test User'
    ...
    , docOptions: [
        ...
        {langCode: 'java', name: 'Java',
            ...
            owner: 'docusign', repo: 'eg-03-java-auth-code-grant', pathPrefix: 'src/main/java/com/docusign/controller/work/'
        },
        {langCode: 'node', name: 'Node.js',
            githubExampleUrl: 'https://github.com/docusign/eg-03-node-auth-code-grant/tree/master/lib/examples/',
            owner: 'docusign', repo: 'eg-03-node-auth-code-grant', pathPrefix: 'lib/work/'
        },
        {langCode: 'curl', name: 'API / curl',
            githubExampleUrl: 'https://github.com/docusign/eg-03-curl/tree/master/examples/',
            owner: 'docusign', repo: 'eg-03-curl', pathPrefix: 'work/'
        },
